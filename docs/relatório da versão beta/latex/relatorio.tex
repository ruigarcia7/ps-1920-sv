...
\documentclass[a4paper,openright,11pt]{report} %twoside,
...
\definecolor{codepurple}{rgb}{0.58,0,0.58}
...
Relatório da versão beta realizado no âmbito de Projeto e Seminário\\
